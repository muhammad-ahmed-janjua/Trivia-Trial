...
<template>
  <section class="bg-l-bg min-h-screen py-36 dark:bg-d-bg flex items-center">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center" style="z-index: 1;">
      <HyperText text="Trivia Time"
        class="dark:text-white text-fission-1 text-4xl font-extrabold sm:text-6xl md:text-[6rem]" :duration="0" />
        <router-link to="/quiz">
  <ShimmerButton
    class="shadow-2xl"
    shimmer-size="2px"
    :background="isDark ? '#f97143' : '#9412f8'"
  >
  ...
  <section ref="categoryTagsSection" class="py-12 dark:bg-d-bg bg-l-bg vh-100 ">
    <div class="bg-l-bg py-20 dark:bg-d-bg flex flex-col items-center px-56">
      <h2 class="text-5xl font-bold text-center mb-20 dark:text-white">How It Works</h2>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 px-4">
        <div class="text-center">
          <h3 class="font-semibold text-2xl mb-6 dark:text-white">1. Choose a Category</h3>
          <p class="text-[1.2rem] text-slate-800 dark:text-white/[0.8]">Select your favorite topic to get started.</p>
        </div>
        <div class="text-center">
          <h3 class="font-semibold text-2xl mb-6 dark:text-white">2. Answer Questions</h3>
          <p class="text-[1.2rem] text-slate-800 dark:text-white/[0.8]">Test your knowledge with carefully crafted trivia questions.</p>
        </div>
        <div class="text-center">
          <h3 class="font-semibold text-2xl mb-6 dark:text-white">3. Compete and Learn</h3>
          <p class="text-[1.2rem] text-slate-800 dark:text-white/[0.8]">Compare scores with friends and learn new facts!</p>
        </div>
      </div>
    </div>
  </section>
